function [trialLayoutBlocks] = SetExperimentOffline(numTest, numBlocks, gridSecs, noControl)
...
trialLayoutBlocks = cell(numBlocks,1);
...
for blockNo=1:numBlocks
    ...
    % Add empty columns for img, control and seg idx
    trialLayout(:,4:6) = nan; 

    % Save it for each block
